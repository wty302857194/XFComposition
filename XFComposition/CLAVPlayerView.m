...
-(void)awakeFromNib
{
    ...
    [self.playOrPauseBigBtn setBackgroundImage:[UIImage imageNamed:@"timg"] forState:UIControlStateNormal];
//    self.imageView.image = [UIImage imageNamed:@"Mic01"];
//    [self.playOrPauseBtn setBackgroundImage:[UIImage imageNamed:@"full_pause_btn"] forState:UIControlStateNormal];
    //imageView添加手势
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(walkVCClick:) name:@"removeMV" object:nil];
}
