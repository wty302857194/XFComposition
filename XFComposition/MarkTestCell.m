...
-(instancetype)initWithFrame:(CGRect)frame{
    if (self = [super initWithFrame:frame]) {
        ...
        self.textfield.sd_layout.leftSpaceToView(self.titleLabel, 0).topSpaceToView(self.contentView, 0).heightIs(35).widthIs(WidthFrame/2-40-80);
