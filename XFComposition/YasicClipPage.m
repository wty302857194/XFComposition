...
- (void)viewDidLoad {
    ...
    [self.bigImageView sd_setImageWithURL:[NSURL URLWithString:_urlStr]];

    self.targetImage = self.bigImageView.image;
...
- (void)viewDidAppear:(BOOL)animated
{
    ...
    [self.cropView bringSubviewToFront:btn];
    btn.sd_layout.leftSpaceToView(self.view, 14);
    btn.sd_layout.rightSpaceToView(self.view, 14);
    btn.sd_layout.bottomEqualToView(self.view);
