...
-(instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        self.label.sd_layout.rightSpaceToView(self.contentView, WidthFrame -120).topSpaceToView(self.contentView, 5).heightIs(30).widthIs(0);
        
        self.label.textAlignment = NSTextAlignmentRight;
        self.label.font  = [UIFont systemFontOfSize:14];
//        [self.label setSingleLineAutoResizeWithMaxWidth:0];
        
        self.textField.sd_layout.leftSpaceToView(self.label, 0).topSpaceToView(self.contentView, 5).heightIs(30).widthIs(WidthFrame-140);
